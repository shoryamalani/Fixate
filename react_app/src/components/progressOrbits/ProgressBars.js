        ...
        <AnimatedProgressProvider
            ...
            >
                {(value) => {
                    ...
                    <Progress type='circle' status={value > 80 ? 'success': 'normal'} percent={value}  size='large' format={()=>{return `${data['label']}`}} strokeColor={{ '0%': data['color_1'], '100%': data['color_2'] }} style={{fontSize:10}} ></Progress>
                    </ConfigProvider>
                );
            }}
        </AnimatedProgressProvider>
...
export { ProgressOrbits as ProgressBars, colors };