...
//             </Button>
//             <Button color='info' variant="contained" style={isUrl('/settings') ? {margin:'1em',backgroundColor:'#33a12a'}: {margin:'1em'} } onClick={() => navigate('/settings')}>
//               <AppsIcon></AppsIcon>Settings
//             </Button>
