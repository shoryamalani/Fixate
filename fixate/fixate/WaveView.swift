...
struct WaveView: Shape {
    ...
    private var finishingFunc: () -> Void
    ...
    init(data: SliderData) {
        ...
        self.finishingFunc = data.finishingFunc
    }
    ...
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let data = SliderData(side: side, centerY: centerY, progress: progress,finishingFunc: finishingFunc)
